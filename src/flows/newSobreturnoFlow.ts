    ...
    .addAnswer(
        ...
        async (ctx, { flowDynamic, state }) => {
            try {
                ...
                console.error('[SOBRETURNO] Error:', error);
                const errorMsg = error.message === 'No hay conexión con el servidor' ?
                    '❌ No pude conectarme al sistema. Por favor, intenta nuevamente más tarde.' :
                    '❌ Ocurrió un error al consultar los sobreturnos. Por favor, intenta nuevamente.';
